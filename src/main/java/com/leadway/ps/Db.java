...
public class Db {
  ...
  private static final String HIBERNATE_NAMING_STRATEGY =
  ...
  public JpaTransactionManager transactionManager() {
    ...
    transactionManager.setEntityManagerFactory(
      entityManagerFactory(dataSource(), environment).getObject()
    );
  ...
  LocalContainerEntityManagerFactoryBean entityManagerFactory(
    ...
    properties.put(
      "spring.jpa.hibernate.temp.use_jdbc_metadata_defaults",
      "false"
    );
