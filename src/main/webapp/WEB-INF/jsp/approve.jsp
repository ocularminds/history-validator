        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
				...
				<div class="form-actions">
					...
					<a class="btn btn-success" href="${pageContext.request.contextPath}/statements/export/${statement.pin}"> <i data-feather="file-text" class="feather-icon"></i>&nbsp;Export Excel</a>&nbsp;
					<a class="btn btn-light" href="${pageContext.request.contextPath}/statements/json/${statement.pin}"> <i data-feather="file-text" class="feather-icon"></i>&nbsp;Export JSON</a>
				    </div>
				</div>
			    </form:form>
                            </div>
