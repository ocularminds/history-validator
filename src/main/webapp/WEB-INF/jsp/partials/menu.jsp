<div class="scroll-sidebar" data-sidebarbg="skin6">
    <nav class="sidebar-nav">
		...
		class="hide-menu">Dashboard</span></a></li>
            ...
            <li class="sidebar-item">
                <a class="sidebar-link" href="${pageContext.request.contextPath}/departments" aria-expanded="false">
            ...
            <li class="sidebar-item">
                <a class="sidebar-link sidebar-link" href="${pageContext.request.contextPath}/users" aria-expanded="false">
                    <i data-feather="message-square" class="feather-icon"></i><span class="hide-menu">Users</span></a>
            </li>
            <li class="list-divider"></li>
